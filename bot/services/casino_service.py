...
# Low-variance paytable: RTP ~94.2% (тот же edge ~6%), но дисперсия
# снижена 2.76→2.12 — больше частых мелких выплат, меньше редких
# джекпотов/фриспин-заносов. Плавнее, реже длинные минусовые серии.
SLOT_PAYTABLE = {
    "diamond": {3: 10, 4: 27, 5: 72},
    "star": {3: 9, 4: 20, 5: 50},
    "bell": {3: 5, 4: 14, 5: 36},
    "lemon": {3: 5, 4: 11, 5: 24},
    "cherry": {3: 4, 4: 10, 5: 20},
}
# Scatter платит от ОБЩЕЙ ставки (не от линии), вне зависимости от позиций.
SLOT_SCATTER_PAY = {3: 2, 4: 4, 5: 10}
SLOT_FREESPINS = {3: 4, 4: 5, 5: 7}
